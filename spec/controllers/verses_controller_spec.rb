  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved verse as @verse" do
        ...
        post :create, {:verse => { "gospel" => "invalid value" }}, valid_session
        assigns(:verse).should be_a_new(Verse)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested verse" do
        ...
        Verse.any_instance.should_receive(:update_attributes).with({ "gospel" => "MyString" })
        put :update, {:id => verse.to_param, :verse => { "gospel" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the verse as @verse" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Verse.any_instance.stub(:save).and_return(false)
        put :update, {:id => verse.to_param, :verse => { "gospel" => "invalid value" }}, valid_session
        assigns(:verse).should eq(verse)
      end
